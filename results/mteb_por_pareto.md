...
Metric: **MTEB(por)** `mean_22` (22 native PT-BR tasks — classification, multilabel-classification,
...
The 128k model ties the full model (0.6491 vs 0.6490 — within noise).
